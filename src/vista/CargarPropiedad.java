 ...
 * @author Aaron
 */
public class CargarPropiedad extends javax.swing.JFrame {
Controlador controlador;
long id;
    /**
     * Creates new form CargarContrato
     */
    public CargarPropiedad(Controlador control) {
        controlador = control;
        initComponents();
        this.setLocationRelativeTo(null);
        id = controlador.idInmueble();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Seleccione-", "Casa", "Local Comercial", "Departamento" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals("") || jTextField1.getText().equals(" ") || jTextField2.getText().equals("") || jTextField2.getText().equals(" ") || jTextField3.getText().equals("") || jTextField3.getText().equals(" ")){
            JOptionPane.showMessageDialog(null, "Carga todos los datos correctamente");
        }else{
            int cantb = Integer.parseInt(jTextField4.getText());
            int canth = Integer.parseInt(jTextField7.getText());
            if(jComboBox1.getSelectedItem().equals("Local Comercial")){
            Localcomercial localcomercial = new Localcomercial(id,jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),canth,cantb,jCheckBox1.isSelected(),3);
            controlador.InsertarLocal(localcomercial);
            }
            if(jComboBox1.getSelectedItem().equals("Departamento")){
            Departamento departamento = new Departamento(id,jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),canth,cantb,jCheckBox1.isSelected(),2);
            controlador.InsertarDepartamento(departamento);
            }
            if(jComboBox1.getSelectedItem().equals("Casa")){
            Casa casa = new Casa(id,jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),canth,cantb,jCheckBox1.isSelected(),1);
            controlador.InsertarCasa(casa);
            }
            id = controlador.idInmueble();
            String idText =String.valueOf(id);
            jTextField8.setText(idText);
