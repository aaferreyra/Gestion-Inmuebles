...
List <Arancel> aranceles;
    ...
    public PagarCuota(Controlador control) {
        ...
        null,
            new String [] {
                "Nro Cuota", "Estado", "Monto 1er Venc","Monto 2do Venc","Primer Vencimiento", "Segundo Vencimiento","Tipo Contrato"
            }
        );
    ...
    private void initComponents() {
        ...
        jLabel11.setText("ID Locatario:");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 80, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 60, -1));
        ...
        jPanel1.add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, -1, -1));
        ...
        jPanel1.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 560, 230));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 50, -1, -1));
    ...
    /*try {
        controlador.ObtenerListaArancelActu(jTextField1.getText());
    } catch (ParseException ex) {
        Logger.getLogger(PagarCuota.class.getName()).log(Level.SEVERE, null, ex);
    }*/
        String matrizpa[][] = controlador.ObtenerMatrizArancel(jTextField1.getText());
        if(matrizpa.length==0){
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                arancelmodel.removeRow(i);
                i-=1;
            }
            JOptionPane.showMessageDialog(null,"El locatario no tiene cuotas a su nombre");
        }else{
        ...
        try {
            ...
            if(fsel==-1){
                ...
                if (JOptionPane.OK_OPTION == confirmado){
                    ...
                    if(jTable1.getValueAt(fsel, 1).toString().equals("Adeuda")){
                        Arancel arancel = controlador.ObtenerArancel(Long.parseLong(id));
                        arancel.setPagado(true);
                        controlador.ActualizarArancel(arancel);
                        for (int i = 0; i < jTable1.getRowCount(); i++) {
                            arancelmodel.removeRow(i);
                            i-=1;
                        }
                        ...
                        JOptionPane.showMessageDialog(null,"La cuota ya se encuentra PAGADA");
                    }
                }
            }
        }catch(Exception e){
