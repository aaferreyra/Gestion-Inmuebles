...
Long id;
     ...
     */
    public ActualizarServicios(Controlador control) {
        controlador = control;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Carga los datos correctamente");
        }else{
            id= Long.parseLong(jTextField1.getText());
            Double monto = Double.parseDouble(jTextField3.getText());
            servicio = new Servicio(id,jTextField2.getText(),monto);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       if(jTextField1.getText().isEmpty() || jTextField1.getText().isBlank()){
            JOptionPane.showMessageDialog(null, "Carga un ID");
        }else{
            id=Long.parseLong(jTextField1.getText());
            servicio = controlador.ObtenerServicio(id);
            if(servicio!=null){
                jTextField2.setText(servicio.getTiposervicio());
                jTextField3.setText(String.valueOf(servicio.getMonto()));
