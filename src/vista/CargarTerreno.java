 ...
 * @author Aaron
 */
public class CargarTerreno extends javax.swing.JFrame {
Controlador controlador;
long id;
    /**
     * Creates new form CargarContrato
     */
    public CargarTerreno(Controlador control) {
        controlador = control;
        initComponents();
        this.setLocationRelativeTo(null);
        id = controlador.idInmueble();
        String idText =String.valueOf(id);
        jTextField4.setText(idText);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        long b = 1;
        List<Inmueble> inmueble = controlador.ObtenerTInmueble();
        ...
        if(jTextField1.getText().equals("") || jTextField1.getText().equals(" ") || jTextField2.getText().equals("") || jTextField2.getText().equals(" ") || jTextField3.getText().equals("") || jTextField3.getText().equals(" ")){
            ...
            Terreno terreno = new Terreno(id,jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),4);
            controlador.InsertarTerreno(terreno);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
            id = controlador.idInmueble();
