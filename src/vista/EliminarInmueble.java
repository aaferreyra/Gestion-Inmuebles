...
Terreno terreno;
     ...
     */
    public EliminarInmueble(Controlador control) {
        controlador = control;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(terreno == null && casa == null && local == null && departamento == null){
            JOptionPane.showMessageDialog(null, "Carga todos los datos correctamente");
        }else{
             if(null == terreno){
             } else {
                 controlador.EliminarTerreno(terreno);
            }
             if(null != casa){
                 controlador.EliminarCasa(casa);
             }
             if(null != departamento){
                 controlador.EliminarDepartamento(departamento);
             }
             if(null != local){
                 controlador.EliminarLocal(local);
             }
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        long id = Long.parseLong(jTextField8.getText());
        casa = controlador.ObtenerCasa(id);
        terreno = controlador.ObtenerTerreno(id);
        departamento = controlador.ObtenerDepartamento(id);
        local = controlador.ObtenerLocal(id);
        if(null != terreno){
            jTextField9.setText("Terreno");
        ...
        if(null != casa){
            jTextField9.setText("Casa");
            jTextField1.setText(casa.getUbicacion());
            jTextField2.setText(casa.getTamano());
            jTextField3.setText(casa.getLocalidad());
            String banos = String.valueOf(casa.getCantidadbanos());
            jTextField4.setText(banos);
            String habs = String.valueOf(casa.getCantidadhabitaciones());
            jTextField7.setText(habs);
            jCheckBox1.setSelected(casa.getCochera());
            jPanel3.setVisible(true);
        }
        if(null != departamento){
            jTextField9.setText("Departamento");
            ...
            String banos = String.valueOf(departamento.getCantidadbanos());
            jTextField4.setText(banos);
            String habs = String.valueOf(departamento.getCantidadhabitaciones());
            jTextField7.setText(habs);
            jCheckBox1.setSelected(departamento.getCochera());
            jPanel3.setVisible(true);
        }
        if(local != null){
            jTextField9.setText("Localcomercial");
            jTextField1.setText(local.getUbicacion());
            jTextField2.setText(local.getTamano());
            jTextField3.setText(local.getLocalidad());
            String banos = String.valueOf(local.getCantidadbanos());
            jTextField4.setText(banos);
            String habs = String.valueOf(local.getCantidadhabitaciones());
            jTextField7.setText(habs);
